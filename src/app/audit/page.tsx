...
export const metadata: Metadata = { title: 'Audit immobilier express' }
  ...
  return (
    <div style= minHeight: '100vh', backgroundColor: t.surface >
      ...
      <main style={mainStyle}>
        <div style={cardStyle}>
          <p style= fontSize: '10px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.18em', color: t.brand, marginBottom: '12px' >Audit express</p>
          <h1 style= fontSize: '24px', fontWeight: 900, color: t.fg, marginBottom: '12px', letterSpacing: '-0.02em' >Audit immobilier</h1>
