...
const outils = [
  {
    ...
    description: `Obtenez une estimation gratuite de votre bien en 3 minutes, basée sur les ventes réelles du marché.`,
  ...
  },
  {
    ...
    description: `Décrivez votre projet et recevez une analyse personnalisée des biens disponibles dans votre zone.`,
  ...
  },
  {
    ...
    description: `Évaluez l'état général d'un bien avant achat ou avant mise en vente avec notre checklist experte.`,
    cta: `Lancer l'audit`,
  },
]
      ...
      <section className="py-16 md:py-24">
        <div className="container-app text-center">
          ...
          <p className="text-lg font-light leading-relaxed text-[#64748B] max-w-2xl mx-auto">
            {`Estimation de vente, projet d'achat ou audit de bien — obtenez des résultats personnalisés en quelques minutes, sans engagement.`}
          </p>
        </div>
      </section>
            ...
            {outils.map((outil) => {
              ...
              return (
                <Link
                  key={outil.href}
                  href={outil.href}
                  className="group block rounded-2xl border border-[#E2E8F0] bg-white p-8 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
                >
                  <div className="mb-5 inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#EFF6FF]">
                  ...
                  <span className="inline-flex items-center gap-2 text-sm font-semibold text-[#0066FF] group-hover:gap-3 transition-all">
                    {outil.cta}
                    <ArrowRight size={16} />
                  </span>
                </Link>
