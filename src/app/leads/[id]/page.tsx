        ...
        <div style={twoCol}>
          ...
          <div style={card}>
            <div style={cardHeader}>
              ...
              {pending.length > 0 && (
                <span style={pendingBadge}>{pending.length} en attente</span>
              )}
            </div>
            ...
            {pending.map((r, i) => {
              ...
              return (
                <div key={r.id as string} style={isLast ? taskRowLast : taskRow}>
                  ...
                  <div style={taskInner}>
                    <div style={taskTitle}>{lbl}{r.titre ? ` — ${r.titre}` : ''}</div>
                    <div style={isLate ? taskDateLate : taskDate}>{isLate ? '⚠️ ' : ''}{time}</div>
                  </div>
            ...
            {completed.map((r, i) => {
              ...
              return (
                <div key={r.id as string} style={isLast ? taskRowLast : taskRow}>
                  <span style={taskIcon}>{icon}</span>
                  <div style={taskInner}>
                    <div style={taskTitleDone}>{lbl}{r.titre ? ` — ${r.titre}` : ''}</div>
                    <div style={taskDate}>{time}</div>
                  </div>
          ...
          <div style={card}>
            ...
            {statut !== 'nouveau' && (
              <div style={actRowLast}>
                <span style={actIcon}>🔄</span>
                <div style={actInner}>
                  <div style={actTitle}>Statut</div>
